...
# =================================================================
# NUEVA CLASE: TEXTO FLOTANTE (FEEDBACK VISUAL)
# =================================================================
class TextoFlotante:
...
class EstadoCombate(EstadoJuego):
    ...
    def manejar_evento(self, evento):
        ...
        if self.motor.turno_actual == "JUGADOR":
            if evento.key == pygame.K_a:
                ...
                # Instanciamos el número flotante sobre el Orco (color Blanco/Amarillo)
            ...
            if evento.key == pygame.K_SPACE:
                ...
                # Instanciamos el número flotante sobre el Héroe (color Rojo)
            ...
            if evento.key == pygame.K_RETURN:
                ...
                self.motor.efecto_combate_activo = None
                self.motor.textos_flotantes.clear() # Limpiamos los textos al salir
    ...
    def actualizar(self):
        # Actualizamos la posición y opacidad de los textos flotantes
        for texto in self.motor.textos_flotantes[:]:
            texto.actualizar()
            # Si el texto ya es invisible, lo borramos de la memoria
            if texto.opacidad <= 0:
    ...
    def dibujar(self):
        ...
        # --- NUEVO: Dibujamos los números de daño por encima de todo ---
        for texto in self.motor.textos_flotantes:
...
class MotorGrafico:
    def __init__(self, heroe: Personaje, mundo: Escenario):
        ...
        # --- NUEVO: Lista global para guardar los textos de daño ---
    ...
    def actualizar(self):
        # Delegamos la lógica de frame al estado activo
